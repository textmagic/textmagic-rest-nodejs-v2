...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateEmailCampaignInputObject', function() {
      beforeEach(function() {
        instance = new TextmagicClient.CreateEmailCampaignInputObject();
      });

      it('should create an instance of CreateEmailCampaignInputObject', function() {
        // TODO: update the code to test CreateEmailCampaignInputObject
        expect(instance).to.be.a(TextmagicClient.CreateEmailCampaignInputObject);
      });
