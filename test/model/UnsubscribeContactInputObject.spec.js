  ...
  describe('(package)', function() {
    describe('UnsubscribeContactInputObject', function() {
      ...
      it('should create an instance of UnsubscribeContactInputObject', function() {
        // TODO: update the code to test UnsubscribeContactInputObject
      ...
      it('should have the property blockIncoming (base name: "blockIncoming")', function() {
        // TODO: update the code to test the property blockIncoming
        expect(instance).to.have.property('blockIncoming');
        // expect(instance.blockIncoming).to.be(expectedValueLiteral);
      });
