...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScheduleEmailCampaignInputObject', function() {
      beforeEach(function() {
        instance = new TextmagicClient.ScheduleEmailCampaignInputObject();
      });

      it('should create an instance of ScheduleEmailCampaignInputObject', function() {
        // TODO: update the code to test ScheduleEmailCampaignInputObject
        expect(instance).to.be.a(TextmagicClient.ScheduleEmailCampaignInputObject);
      });
      ...
      it('should have the property scheduleParams (base name: "scheduleParams")', function() {
        // TODO: update the code to test the property scheduleParams
        expect(instance).to.have.property('scheduleParams');
        // expect(instance.scheduleParams).to.be(expectedValueLiteral);
      });
