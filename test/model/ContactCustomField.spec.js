  ...
  describe('(package)', function() {
    describe('ContactCustomField', function() {
      ...
      it('should create an instance of ContactCustomField', function() {
        // TODO: update the code to test ContactCustomField
      ...
      it('should have the property userCustomField (base name: "userCustomField")', function() {
        // TODO: update the code to test the property userCustomField
        expect(instance).to.have.property('userCustomField');
        // expect(instance.userCustomField).to.be(expectedValueLiteral);
      });
