...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MessageOutSession', function() {
      beforeEach(function() {
        instance = new TextmagicClient.MessageOutSession();
      });

      it('should create an instance of MessageOutSession', function() {
        // TODO: update the code to test MessageOutSession
        expect(instance).to.be.a(TextmagicClient.MessageOutSession);
      });
