  ...
  describe('(package)', function() {
    describe('UpdateContactInputObject', function() {
      ...
      it('should create an instance of UpdateContactInputObject', function() {
        // TODO: update the code to test UpdateContactInputObject
      ...
      it('should have the property customFieldValues (base name: "customFieldValues")', function() {
        // TODO: update the code to test the property customFieldValues
        expect(instance).to.have.property('customFieldValues');
        // expect(instance.customFieldValues).to.be(expectedValueLiteral);
      });
