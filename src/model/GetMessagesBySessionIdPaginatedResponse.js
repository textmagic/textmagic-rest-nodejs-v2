...
class GetMessagesBySessionIdPaginatedResponse {
    ...
    constructor(page, pageCount, limit, resources) { 
        ...
        GetMessagesBySessionIdPaginatedResponse.initialize(this, page, pageCount, limit, resources);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMessagesBySessionIdPaginatedResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetMessagesBySessionIdPaginatedResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMessagesBySessionIdPaginatedResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetMessagesBySessionIdPaginatedResponse.RequiredProperties) {
...
GetMessagesBySessionIdPaginatedResponse.RequiredProperties = ["page", "pageCount", "limit", "resources"];

/**
 * @member {Number} page
 */
GetMessagesBySessionIdPaginatedResponse.prototype['page'] = undefined;

/**
 * The total number of pages.
 * @member {Number} pageCount
 */
GetMessagesBySessionIdPaginatedResponse.prototype['pageCount'] = undefined;

/**
 * The number of results per page.
 * @member {Number} limit
 */
GetMessagesBySessionIdPaginatedResponse.prototype['limit'] = undefined;

/**
 * @member {Array.<module:model/MessageOut>} resources
 */
GetMessagesBySessionIdPaginatedResponse.prototype['resources'] = undefined;
...
export default GetMessagesBySessionIdPaginatedResponse;
