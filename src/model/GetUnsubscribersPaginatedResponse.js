...
import UnsubscribedContact from './UnsubscribedContact';
...
class GetUnsubscribersPaginatedResponse {
    ...
    constructor(page, pageCount, limit, resources) { 
        ...
        GetUnsubscribersPaginatedResponse.initialize(this, page, pageCount, limit, resources);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUnsubscribersPaginatedResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUnsubscribersPaginatedResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUnsubscribersPaginatedResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetUnsubscribersPaginatedResponse.RequiredProperties) {
        ...
        if (data['resources']) { // data not null
            ...
            for (const item of data['resources']) {
                UnsubscribedContact.validateJSON(item);
            };
        }
...
GetUnsubscribersPaginatedResponse.RequiredProperties = ["page", "pageCount", "limit", "resources"];

/**
 * @member {Number} page
 */
GetUnsubscribersPaginatedResponse.prototype['page'] = undefined;

/**
 * The total number of pages.
 * @member {Number} pageCount
 */
GetUnsubscribersPaginatedResponse.prototype['pageCount'] = undefined;

/**
 * The number of results per page.
 * @member {Number} limit
 */
GetUnsubscribersPaginatedResponse.prototype['limit'] = undefined;

/**
 * @member {Array.<module:model/UnsubscribedContact>} resources
 */
GetUnsubscribersPaginatedResponse.prototype['resources'] = undefined;
...
export default GetUnsubscribersPaginatedResponse;
