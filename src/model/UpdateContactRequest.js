 ...
 */
UpdateContactRequest.prototype['firstName'] = undefined;

/**
 * Contact last name.
 * @member {String} lastName
 */
UpdateContactRequest.prototype['lastName'] = undefined;

/**
 * Phone number in [E.164 format](https://en.wikipedia.org/wiki/E.164).
 * @member {String} phone
 */
UpdateContactRequest.prototype['phone'] = undefined;

/**
 * Contact email address.
 * @member {String} email
 */
UpdateContactRequest.prototype['email'] = undefined;

/**
 * Contact company name.
 * @member {String} companyName
 */
UpdateContactRequest.prototype['companyName'] = undefined;

/**
 * Comma-separated [list](https://docs.textmagic.com/#section/Lists) ID. Each contact must be assigned to at least one list.
 * @member {String} lists
 */
UpdateContactRequest.prototype['lists'] = undefined;

/**
 * Is the contact marked as favorite?
 * @member {Boolean} favorited
 */
UpdateContactRequest.prototype['favorited'] = undefined;

/**
 * Is the contact blocked for outgoing and incoming messaging?
 * @member {Boolean} blocked
 */
UpdateContactRequest.prototype['blocked'] = undefined;

/**
 * Force type of phone. Possible values: 0 is landline; 1 is mobile; default is -1 (auto-detection).
 * @member {Number} type
 */
UpdateContactRequest.prototype['type'] = undefined;

/**
 * @member {Array.<module:model/CustomFieldListItem>} customFieldValues
 */
UpdateContactRequest.prototype['customFieldValues'] = undefined;

/**
 * Treat phone numbers passed in the request body as **local**.
 * @member {Number} local
 */
UpdateContactRequest.prototype['local'] = undefined;

/**
 * The 2-letter ISO country code for local phone numbers, used when **local** is set to true.
 * @member {String} country
 */
UpdateContactRequest.prototype['country'] = undefined;

/**
 * An array of tag IDs that will be assigned to the contact.
 * @member {Array.<Number>} tags
 */
UpdateContactRequest.prototype['tags'] = undefined;

/**
 * Contact Owner ID
 * @member {Number} owner
 */
UpdateContactRequest.prototype['owner'] = undefined;
