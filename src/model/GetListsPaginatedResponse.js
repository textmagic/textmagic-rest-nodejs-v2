...
class GetListsPaginatedResponse {
    ...
    constructor(page, pageCount, limit, resources) { 
        ...
        GetListsPaginatedResponse.initialize(this, page, pageCount, limit, resources);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetListsPaginatedResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetListsPaginatedResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetListsPaginatedResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetListsPaginatedResponse.RequiredProperties) {
...
GetListsPaginatedResponse.RequiredProperties = ["page", "pageCount", "limit", "resources"];

/**
 * @member {Number} page
 */
GetListsPaginatedResponse.prototype['page'] = undefined;

/**
 * The total number of pages.
 * @member {Number} pageCount
 */
GetListsPaginatedResponse.prototype['pageCount'] = undefined;

/**
 * The number of results per page.
 * @member {Number} limit
 */
GetListsPaginatedResponse.prototype['limit'] = undefined;

/**
 * @member {Array.<Array>} resources
 */
GetListsPaginatedResponse.prototype['resources'] = undefined;
...
export default GetListsPaginatedResponse;
