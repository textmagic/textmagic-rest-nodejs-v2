...
class GetSurveysPaginatedResponse {
    ...
    constructor(page, pageCount, limit, resources) { 
        ...
        GetSurveysPaginatedResponse.initialize(this, page, pageCount, limit, resources);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSurveysPaginatedResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSurveysPaginatedResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSurveysPaginatedResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetSurveysPaginatedResponse.RequiredProperties) {
...
GetSurveysPaginatedResponse.RequiredProperties = ["page", "pageCount", "limit", "resources"];

/**
 * @member {Number} page
 */
GetSurveysPaginatedResponse.prototype['page'] = undefined;

/**
 * The total number of pages.
 * @member {Number} pageCount
 */
GetSurveysPaginatedResponse.prototype['pageCount'] = undefined;

/**
 * The number of results per page.
 * @member {Number} limit
 */
GetSurveysPaginatedResponse.prototype['limit'] = undefined;

/**
 * @member {Array.<module:model/Survey>} resources
 */
GetSurveysPaginatedResponse.prototype['resources'] = undefined;
...
export default GetSurveysPaginatedResponse;
